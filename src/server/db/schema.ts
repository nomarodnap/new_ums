...
export const budgets = pgTable("budgets", {
  ...
  transferredAmount: decimal("transferred_amount", { precision: 15, scale: 2 }).notNull().default('0'),
  departmentId: text("department_id").notNull(),
...
export const audits = pgTable("audits", {
  ...
  isOverdueMoreThan2Months: boolean("is_overdue_more_than_2_months").default(false),
